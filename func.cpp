...
{
    std::string input = "studentai" + std::to_string(size) + ".txt";
...
void ReadFile(MyVector<Student> &studVector, int& size)
{
    try
    {
...
void Selection(MyVector<Student> &studVector, MyVector<Student> &best, int choice, int& size)
{
    try
    {
        if (choice == 1)
        {
            ...
            std::ofstream output1("Pazenge" + std::to_string(size) + ".txt");
            ...
            for (const auto &i : best)
                output1 << i;
            output1.close();
            std::ofstream output2("Nepazenge" + std::to_string(size) + ".txt");
        ...
        if (choice == 2)
        {
            ...
            const auto start2 = std::chrono::high_resolution_clock::now();
            std::ofstream output1("Pazenge.txt");
            output1 << std::left << std::setw(15) << "Pavarde" << std::setw(15) << "Vardas" << std::setw(20) << "Galutinis (Vid.)" << std::setw(15) << "Galutinis (Med.)" << std::endl;
            output1 << "------------------------------------------------------------------" << std::endl;
            output1 << std::fixed << std::setprecision(2);
            for (const auto &i : best)
                output1 << i << std::endl;
            output1.close();
            std::ofstream output2("Nepazenge.txt");
            output2 << std::left << std::setw(15) << "Pavarde" << std::setw(15) << "Vardas" << std::setw(20) << "Galutinis (Vid.)" << std::setw(15) << "Galutinis (Med.)" << std::endl;
            output2 << "------------------------------------------------------------------" << std::endl;
            output2 << std::fixed << std::setprecision(2);
            for (const auto &i : studVector)
